...
payouts = requests.get('https://api2.nicehash.com/main/api/v2/mining/rigs/payouts?page=steven_straughen%40yahoo.com')
payouts = payouts.json()
payouts = json.dumps(payouts,sort_keys=True, indent = 4)

print(payouts)

payouts2 = requests.get('https://api2.nicehash.com/main/api/v2/mining/rigs/payouts/')
payouts2 = payouts2.json()
payouts2 = json.dumps(payouts2,sort_keys=True, indent = 4)
...
#cHandler.execute('select * from hrg_make')
...
#    item_id = row[0]
#    hrg_make = row[1]
#    print ("ITEM ID = %s    HRG Make = %s" % \
#        (item_id, hrg_make))

#print('\n')

#cHandler.execute('select * from hrg_model')
#results = cHandler.fetchall()

#for row in results:
#    item_id = row[0]
#    hrg_make = row[1]
#    print ("ITEM ID = %s    HRG Model = %s" % \
#        (item_id, hrg_make))
